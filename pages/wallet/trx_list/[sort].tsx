    ...
    <div className="w-full">
      ...
      <div className="flex flex-col items-start justify-start w-full bg-white mobile:p-3 mb-2">
        <select className="select select-bordered w-full bg-gray-200 text-slate-700">
          <option disabled selected><FaSort /> All transactions</option>
      ...
      <div className="flex flex-row items-center justify-center space-x-3 bg-transparent w-full mobile:p-3">
        <ButtonGhost type="normal" text="Load more" icon={undefined} iconPosition={undefined} block={true} onClick={e => console.log(e, "Lord more transactions")} />
      </div>
    </div>
  );
}
...
const TransactionsList = ({ router, data }) => {
  ...
  return (
    <OnboardCard>
      ...
      <div className="divider my-2"></div> 
      <TransactionIn title="Staking redeemed" subText="July 24, 2022 11:35 AM" amount="488.00" onClick={(e) => {
        console.log(e, "More trnx details");
        router.push('/wallet/trx_detail/trx-121343');
      }} />
      <div className="divider my-2"></div> 
      <TransactionIn title="NFT sale" subText="July 24, 2022 11:35 AM" amount="488.00" onClick={(e) => {
        console.log(e, "More trnx details");
        router.push('/wallet/trx_detail/trx-121343');
      }} />
      <div className="divider my-2"></div> 
      <TransactionOut title="Survey fees" subText="July 24, 2022 11:35 AM" amount="67.49" onClick={(e) => {
        console.log(e, "More trnx details");
        router.push('/wallet/trx_detail/trx-123142');
      }} />
      <div className="divider my-2"></div> 
      <TransactionIn title="Deposit" subText="July 24, 2022 11:35 AM" amount="488.00" onClick={(e) => {
        console.log(e, "More trnx details");
        router.push('/wallet/trx_detail/trx-121343');
      }} />
      <div className="divider my-2"></div> 
      <TransactionOut title="NFT purchase" subText="July 24, 2022 11:35 AM" amount="67.49" onClick={(e) => {
        console.log(e, "More trnx details");
        router.push('/wallet/trx_detail/trx-123142');
      }} />
      <div className="divider my-2"></div> 
      <TransactionOut title="Staked token" subText="July 24, 2022 11:35 AM" amount="67.49" onClick={(e) => {
        console.log(e, "More trnx details");
        router.push('/wallet/trx_detail/trx-123142');
      }} />
    </OnboardCard>
