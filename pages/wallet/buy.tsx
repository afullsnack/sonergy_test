  ...
  return (
    <div className="w-full">
      <div className="flex flex-col items-start justify-start w-full bg-transparent mobile:p-3 mb-10">
        <OnboardCard>
          <div
            className="w-full p-3 mx-auto bg-white dark:bg-slate-900 rounded-lg flex items-center space-x-4 border-[#E2EDF6] border-[0.5px] mb-3"
            onClick={(e) => console.log(e, "DEX clicked")}
          >
            ...
            <div className="flex items-center justify-between space-x-2">
              <div>
                <div className="text-[16px] font-semibold text-gray-700 dark:text-gray-300">
                  DEX
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 font-normal">
                  Swap sonergy token on decentralized exchanges.
                </p>
              </div>
          ...
          <div
            className="w-full p-3 mx-auto bg-white dark:bg-slate-900 rounded-lg flex items-center space-x-4 border-[#E2EDF6] border-[0.5px] mb-3"
            onClick={(e) => console.log(e, "CEX clicked")}
          >
            {/* <div className="shrink-0 rounded-2xl border-solid border-primary border-[.9px] p-3">
              <FaCheck size={18} />
            </div> */}
            <div className="flex items-center justify-between space-x-2">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 font-normal">
                  Buy, trade sonergy token on centralized exchanges.
                </p>
              </div>
              {/* <AiOutlineRight color="black" /> */}
            </div>
          ...
          <div
            className="w-full p-3 mx-auto bg-white dark:bg-slate-900 rounded-lg flex items-center space-x-4 border-[#E2EDF6] border-[0.5px] mb-3"
            onClick={(e) => console.log(e, "P2P clicked")}
          >
            {/* <div className="shrink-0 rounded-2xl border-solid border-primary border-[.9px] p-3">
              <FaCheck size={18} />
            </div> */}
            <div className="flex items-center justify-between space-x-2">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 font-normal">
                  Buy, trade sonergy token with verified merchants on sonergy.io
                </p>
              </div>
              {/* <AiOutlineRight color="black" /> */}
            </div>
          ...
          <div
            className="w-full p-3 mx-auto bg-white dark:bg-slate-900 rounded-lg flex items-center space-x-4 border-[#E2EDF6] border-[0.5px] mb-3"
            onClick={(e) => console.log(e, "Card clicked")}
          >
            {/* <div className="shrink-0 rounded-2xl border-solid border-primary border-[.9px] p-3">
              <FaCheck size={18} />
            </div> */}
            <div className="flex items-center justify-between space-x-2">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 font-normal">
                  Buy Sonergy tokens directly from your debit or credit cards
                </p>
              </div>
              {/* <AiOutlineRight color="black" /> */}
            </div>
