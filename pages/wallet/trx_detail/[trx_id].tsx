    ...
    <div className="w-full">
      <div className="flex flex-col items-start justify-start w-full bg-transparent mobile:p-3 mb-10">
        ...
        <OnboardCard>
          ...
          <div className="badge bg-green-600 text-white font-light border-none mt-0 mb-5 mx-auto">
            Completed
          </div>
          <div className="w-full flex flex-col border-dashed border-slate-400 border-[1px] bg-slate-100 rounded-lg p-4">
            ...
            <span className="text-xs font-medium text-gray-800 mb-3">
              0x783a...6bd28a45254650
            </span>
            <span className="text-xs text-gray-500 mb-1">Transaction ID</span>
            <span className="text-xs font-medium text-gray-800 mb-3 flex items-center justify-between">
              783a...6bd28a45bd28a4254650 <FaCopy color="#8895A7" />{" "}
            </span>
            ...
            <span className="text-xs font-light text-gray-800 mb-3">
              <b className="font-semibold">0.10</b> (SNEGY){" "}
            </span>
          </div>
        </OnboardCard>
      </div>
