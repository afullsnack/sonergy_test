...
import { ButtonGhost, ButtonIcon, ButtonPrimary } from "../../components/Button";
    ...
    <div className="w-full">
      ...
      <div className="flex flex-col items-start justify-start w-full bg-white mobile:p-3 mb-10">
        <div className="flex items-center justify-center w-[100%] mb-2">
          <button className="flex-1 mx-1 p-2 rounded-md border-solid border-[1px] border-slate-200 mobile:text-xs">Commissioned</button>
          <button className="flex-1 mx-1 p-2 rounded-md border-solid border-[1px] border-slate-200 mobile:text-xs">Completed</button>
          <button className="flex-1 mx-1 p-2 rounded-md border-solid border-[1px] border-slate-200 mobile:text-xs">Validated</button>
        </div>
        ...
        <OnboardCard>
          <div className="border-solid border-[1px] border-slate-200 rounded-lg p-4 mb-3">
            <div className="flex flex-col items-start justify-between mb-3">
              <div className="badge bg-orange-200 text-orange-700 text-xs border-none mb-3">Pending completion</div>
              ...
              <p className="flex items-center justify-center"><b className="text-gray-700 text-mf font-medium">200 SNEGY</b> </p>
          ...
          <div className="border-solid border-[1px] border-slate-200 rounded-lg p-4 mb-3">
            <div className="flex flex-col items-start justify-between mb-3">
              <div className="badge bg-green-200 text-green-700 text-xs border-none mb-3">Completed</div>
              <span className="text-gray-700 text-sm font-normal text-left mb-2">Blockchain development and utilisation in sub-saharan Africa.</span>
              <p className="flex items-center justify-center"><b className="text-gray-700 text-mf font-medium">200 SNEGY</b> </p>
              <p className="flex items-center justify-center"> <AiFillClockCircle size={14} /><span className="text-xs text-gray-500 ml-1">Expires in 2 days 11 hours</span> </p>
            </div>
      ...
      <div className="flex flex-col items-start justify-start bg-white w-full mobile:p-3">
        <ButtonPrimary type="normal" text="Analyze survey" icon={undefined} iconPosition={undefined} block={true} onClick={e => console.log(e, "Analyze survey")} />
      </div>
    </div>
  );
}
