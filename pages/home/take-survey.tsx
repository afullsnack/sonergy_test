  ...
  <>
    <div className="flex flex-col items-start justify-start w-full max-h-full bg-transparent mobile:p-3 mb-10">
      <div className="flex items-center justify-start space-x-1 mb-3" onClick={e => router.back()}>
        <AiFillLeftCircle />
        <span className="text-sm font-medium text-gray-800">Survey details</span>
      </div>
      <OnboardCard>
        <span className="text-xs text-center text-slate-800 font-light mb-2">Survey rewards</span>
        <p className="flex items-center justify-center mb-4"><b className="text-md text-slate-800 font-medium">200.<small className="text-xs">00 <span className="text-2xs font-light ml-1">SNEGY</span></small></b></p>
        <div className="w-full flex flex-col border-dashed border-slate-400 border-[1px] bg-slate-100 rounded-lg p-4">
          ...
          <span className="text-xs font-medium text-gray-800 mb-3">Blockchain development and utilization in sub-saharan Africa.</span>
          <span className="text-xs text-gray-500 mb-1">Questions</span>
          <span className="text-xs font-medium text-gray-800 mb-3">12</span>
          <span className="text-xs text-gray-500 mb-1">Required respondents</span>
          <span className="text-xs font-medium text-gray-800 mb-3">50</span>
          <span className="text-xs text-gray-500 mb-1">Required validators</span>
    ...
    <div className="flex flex-col items-start justify-start w-full bg-white mobile:p-3">
      <ButtonPrimary type="normal" text="Answer survey" icon={undefined} iconPosition={undefined} block={true} onClick={e => console.log(e, "answer survey")} />
    </div>
  </>
)
  ...
  return (
    ...
    <div className="flex flex-col items-start justify-start w-full bg-transparent mobile:p-3 mb-10">
      <OnboardCard>
        ...
        <span className="text-xs font-medium text-gray-500 mb-4">Questions 1 of 3</span>
        <span className="text-md font-medium text-gray-800 mb-5">What is your favorite type of dessert?</span>
        <div className="form-control">
          <label className="label justify-start cursor-pointer">
            <input type="radio" name="radio-6" className="radio mr-2 checked:bg-primary" checked />
...
const SurveyFinished = ({ router }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-start justify-start w-full bg-white mobile:p-3">
      <ButtonPrimary type="normal" text="Let’s do more" icon={undefined} iconPosition={undefined} block={true} onClick={e => console.log(e, "Lets do more")} />
    </div>
    </>
  );
}
