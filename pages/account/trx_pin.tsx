  ...
  return (
    <div className="w-full">
      ...
      <OnboardCard>
          ...
          <span className="text-lg font-[600] text-gray-700 mb-1">Transaction PIN</span>
          <span className="text-[14px] font-[400] text-gray-600 mb-4">Set / update your transaction PIN</span>

          <div className="form-control mb-5">
            <label className="label">
              <span className="label-text text-slate-700 font-medium">Transaction PIN</span>
            </label>
          ...
          <ButtonPrimary type="normal" text="Save PIN" icon={undefined} iconPosition={undefined} block={true} onClick={e => console.log(e, "Save pin clicked")} />
        </OnboardCard>
      </div>
    </div>
  );
