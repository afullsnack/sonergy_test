          ...
          <div className="form-control mb-5">
            ...
            <div className="flex justify-center items-center w-full">
              <label
                ...
                className="flex flex-col justify-center items-center w-full h-auto bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
              >
                <div className="flex flex-col justify-center items-center pt-6 pb-7">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    PNG, JPG or PDF (Max upload size. 100MB)
                  </p>
                </div>
...
const VerificationAlert = () => (
  <div
    className="flex p-4 mb-4 text-sm  bg-blue-100 rounded-lg border-blue-400 border-dashed border-[1.5px] dark:border-blue-400 dark:bg-blue-200 "
    role="alert"
  >
    <svg
      className="inline flex-shrink-0 mr-3 w-5 h-5 text-gray-700 dark:text-blue-700"
      fill="currentColor"
      viewBox="0 0 20 20"
      xmlns="http://www.w3.org/2000/svg"
    >
    ...
    <div>
      <span className="font-[400] text-xs dark:text-gray-700 text-gray-700">
        Your verification document has been received, It typically takes 48
        hours to be reviewed. Track your verification status on your profile
        tab.
      </span>
    </div>
  </div>
